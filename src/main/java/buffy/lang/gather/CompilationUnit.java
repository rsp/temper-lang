...
/**
 * Corresponds to a fenced buffy code block.
 */
public final class CompilationUnit {
   ...
   * <p>
   * This is computed by looking back for
   * <ol>
   ...
   *
   * <p>
   * In any case, traversal stops when a relevant fenced code block is seen lexically
   * between the current code block and the markdown element that specifies the ID.
   *
   * <p>
   * A "relevant" fenced code block is one whose {@linkplain CodeBlockVariant#fenceId fence id}
   * {@linkplain CodeBlockVariant#forFenceId corresponds} to a {@link CodeBlockVariant}.
   *
   * <p>
   * To compute a fragment identifier:
   * <ul>
   ...
   *       <br>It is a goal to track Github markdown auto-identifier conventions as closely as possible.
   ...
   * </ol>
   */
  public final Optional<String> fragmentIdentifier;

  /** Constructor. */
  public CompilationUnit(
          CodeBlockVariant codeBlockVariant, SourcePosition codePosition,
          Optional<String> fragmentIdentifier) {
  ...
  public String toString() {
    return "{CompilationUnit " + this.codePosition
            + (this.fragmentIdentifier.isPresent() ? "#" + this.fragmentIdentifier.get() : "")
            + "}";
  }
}
