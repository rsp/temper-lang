...
/**
 * Expectations about how a code block should run and whether it should succeed.
 */
public enum CodeBlockVariant {
  /** Temper production code. */
  PRODUCTION("tmpr"),
  /** Privileged temper test code. */
  TEST("tmpt"),
  /** Temper example code that should pass. */
  EXAMPLE("tmpe"),
  /** Temper example code that should panic. */
  PANICS("tmpp"),
  ;
