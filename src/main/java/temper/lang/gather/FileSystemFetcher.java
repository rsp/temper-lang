 ...
 */
public final class FileSystemFetcher implements Fetcher {
  private final FileSystem fs;

  /** A fetcher that operates on the default FileSystem. */
  public FileSystemFetcher() {
    this(FileSystems.getDefault());
  }

  /** A fetcher that operates on the given FileSystem. */
